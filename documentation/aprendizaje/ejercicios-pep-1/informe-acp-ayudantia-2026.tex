...
\begin{axis}[
  ...
  title={Variables originales P2 (billetes)}]
\draw[gray, dashed] (axis cs:0,0) circle [radius=1];
\arr{0.395}{0.799}{LON}{south}
\arr{0.207}{0.345}{LD}{south west}
\arr{0.445}{-0.263}{AI}{north}
\arr{0.411}{-0.375}{AD}{north west}
\arr{0.347}{-0.072}{AMI}{north}
\arr{0.560}{-0.163}{AMS}{east}
\end{axis}
\end{tikzpicture}
\caption{Variables del problema P2 en el plano factorial.}
\end{figure}
