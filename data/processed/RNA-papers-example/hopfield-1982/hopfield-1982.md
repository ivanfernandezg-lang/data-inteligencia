...
given, based on aspects ofneurobiology but readily adapted to in-
...
time evolution of the state ofthe system is based on asynchronous
...
X1
XN, the components of a state vector X. Let the system
have locally stable limit points Xa, Xb,
**. Then, if the system
is started sufficiently near any Xa, as at X = Xa + A, it will
proceed in time until X
Xa. We can regard the information
stored in the system as the vectors Xa, Xb,
. The starting
...
Suppose we wish to store the set of states V8, s = 1
n. We
...
(23, 24).]
A study ofemergent collective effects and spontaneous com-
putation must necessarily focus on the nonlinearity of the in-
put-output relationship. The essence ofcomputation is nonlin-
...
0
Membrane
Potential (Volts) or "Input"
FIG. 1.
Firing rate versus membrane voltage for a typical neuron
...
done on the probability pi ofthe occurrence ofa state in a time
of wandering around this minimum, and an entropic measure
of the available states M was taken
[9]
A value ofM = 25 was found forN = 30. Theflow in phase space
...
would appear random (e.g., the coding sequences ofDNA have
...
i when the state ofthe system is s', one of the nominal memory
...
a state had no errors in its 100 bits should be about eC0O9'
0.40.
...
in State
FIG. 2.
The probability distribution of the occurrence of errors in
...
(101110
) is an assigned stable state, (010001 .) is also stable.
...
a highly nonlinear one) and to examine the efficiency ofstorage.
Only N(N/2) bits of information can possibly be stored in this
symmetric matrix. Experimentally, forN = 100, n = 9, the level
...
digitizing depth of T., and 0,
, ±3 is an appropriate level for
...
Real neurons need not make synapses both of i --
j and j
...
the algorithm is equivalent to raising the effective energy ofthe
...
[13]
S
were added to T . WhenA was judiciously adjusted, the system
...
appear to be strongly dependent on precise details ofthe mod-
...
computational capabilities from the collective behavior oflarge
...
Engineering.
1.
Willows, A. 0. D., Dorsett, D. A. & Hoyle, G. (1973) J. Neu-
robiol 4, 207-237, 255-285.
2.
Kristan, W. B. (1980) in Information Processing in the Nervous
System, eds. Pinsker, H. M. & Willis, W. D. (Raven, New York),
241-261.
3.
Knight, B. W. (1975) Lect. Math. Life Sci. 5, 111-144.
4.
Smith, D. R. & Davidson, C. H. (1962)J. Assoc. Comput. Mach.
9, 268-279.
5.
Harmon, L. D. (1964) in Neural Theory and Modeling, ed. Reiss,
R. F. (Stanford Univ. Press, Stanford, CA), pp. 23-24.
6.
Amari, S.-I. (1977) Bio. Cybern. 26, 175-185.
7.
...
10.
Kohonen, T. (1980) Content Addressable Memories (Springer,
New York).
11.
...
14.
Rosenblatt, F. (1962) Principles of Perceptrons (Spartan, Wash-
ington, DC).
15.
Cooper, L. N. (1973) in Proceedings of the Nobel Symposium on
Collective Properties of Physical Systems, eds. Lundqvist, B. &
Lundqvist, S. (Academic, New York), 252-264.
16.
Cooper, L. N., Liberman, F. & Oja, E. (1979) Biol Cybern. 33,
9-28.
17.
Longuet-Higgins, J. C. (1968) Proc. Roy. Soc. London Ser. B 171,
327-334.
18.
Longuet-Higgins, J. C. (1968) Nature (London) 217, 104-105.
19.
...
21.
Anderson, J. A. (1977) Psych. Rev. 84, 413-451.
22.
Perkel, D. H. & Bullock, T. H. (1969) Neurosci. Res. Symp.
Summ. 3, 405-527.
23.
John, E. R. (1972) Science 177, 850-864.
24.
Roney, K. J., Scheibel, A. B. & Shaw, G. L. (1979) Brain Res.
Rev. 1, 225-271.
25.
...
27.
Hebb, D. 0. (1949) The Organization of Behavior (Wiley, New
York).
28.
Eccles, J. G. (1953) The Neurophysiological Basis ofMind (Clar-
endon, Oxford).
29.
Kirkpatrick, S. & Sherrington, D. (1978) Phys. Rev. 17, 4384-4403.
30.
Mountcastle, V. B. (1978) in The Mindful Brain, eds. Edelman,
G. M. & Mountcastle, V. B. (MIT Press, Cambridge, MA), pp.
36-41.
31.
Goldman,
P.
S. & Nauta, W. J. H. (1977) Brain Res. 122,
393-413.
32.
