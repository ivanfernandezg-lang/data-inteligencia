"""
Regenera todas las tablas LaTeX con formato correcto.
"""
import os
...
# ── tab_iris.tex ──
tab_iris = r"""\begin{tabular}{@{}lccccc@{}}
\toprule
$\mu$ & $\eta$ & Acc. train & Acc. test & Ep. a 95\% & Tiempo (s) \\
\midrule
...
# ── tab_resumen.tex ──
tab_resumen = r"""\begin{tabular}{@{}llll@{}}
\toprule
...
print("Todas las tablas regeneradas correctamente.")
