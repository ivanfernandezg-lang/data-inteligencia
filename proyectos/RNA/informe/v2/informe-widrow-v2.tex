...
\subsection{E6: Datasets reales (MLP y clasificadores lineales)}
...
\figura[0.8]{fig_wine}{Convergencia de clasificadores lineales en Wine. Wiener y \muLMS~alcanzan
98.1\% test.}{wine}

\figura[0.8]{fig_mnist}{MLP 64--16--5 en MNIST dígitos 0--4 (98.5\% test).}{mnist}
\pagebreak
...
equivalencia. La razón MRIII:backpropagation \textbf{crece aproximadamente como
